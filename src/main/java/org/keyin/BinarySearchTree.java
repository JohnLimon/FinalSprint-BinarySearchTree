...
public class BinarySearchTree {
    ...
    public static void main(String[] args) {
        ...
        bst.setLeftChild(root.getLeft(), leftChild);  // Setting left child of node with value 5

        Node rightChild = new Node(6);
        bst.setRightChild(root.getLeft(), rightChild); // Setting right child of node with value 5
